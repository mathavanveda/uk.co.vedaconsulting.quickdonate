...
function quickdonate_civicrm_install() {
  _quickdonate_civix_civicrm_install();
}
...
function quickdonate_civicrm_uninstall() {
  _quickdonate_civix_civicrm_uninstall();
}
...
function quickdonate_civicrm_enable() {
  _quickdonate_civix_civicrm_enable();
}
...
function quickdonate_civicrm_disable() {
  _quickdonate_civix_civicrm_disable();
}
...
function quickdonate_civicrm_managed(&$entities) {
  _quickdonate_civix_civicrm_managed($entities);
}
 ...
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_caseTypes
 */
function quickdonate_civicrm_angularModules(&$angularModules) {
_quickdonate_civix_civicrm_angularModules($angularModules);
}
 ...
 *
function quickdonate_civicrm_preProcess($formName, &$form) {
...
function quickdonate_civicrm_buildForm($formName, &$form) {
  ...
  if ($formName == 'CRM_Profile_Form_Edit' && $session->get('quickdonate_user_email')) {
   $email = $session->get('quickdonate_user_email');
